...
public class XPopup {
    ...
    private static int statusBarBgColor = Color.parseColor("#ffffff");
    private static int navigationBarColor = Color.parseColor("#ffffff");
    private static int shadowBgColor = Color.parseColor("#7F000000");
    public static int isLightStatusBar = 1; //大于0为true，小于0为false
    public static int isLightNavigationBar = 1; //大于0为true，小于0为false
    ...
    public static class Builder {
        ...
        public AttachListPopupView asAttachList(String[] data, int[] iconIds, OnSelectListener selectListener, int bindLayoutId,
                                                int bindItemLayoutId, int contentGravity,int checkPosition) {
            AttachListPopupView popupView = new AttachListPopupView(this.context, bindLayoutId, bindItemLayoutId)
                    ...
                    .setCheckedPosition(checkPosition)
