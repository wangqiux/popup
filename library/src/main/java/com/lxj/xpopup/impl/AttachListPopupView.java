...
//                        imageView.setBackgroundResource(iconIds[position]);
                ...
                if (checkedPosition == position) {
                    holder.<TextView>getView(R.id.tv_text).setTextColor(getResources().getColor(R.color.colorAccent));
                }else {
                    holder.<TextView>getView(R.id.tv_text).setTextColor(Color.parseColor("#333333"));
                }
            }
        };
     ...
     * @return
     */
    public AttachListPopupView setCheckedPosition(int position) {
