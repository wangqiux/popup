    ...
    protected void onCreate() {
        ...
        final EasyAdapter<String> adapter = new EasyAdapter<String>(Arrays.asList(data), bindItemLayoutId == 0 ? R.layout._xpopup_adapter_text_match : bindItemLayoutId) {
            ...
            protected void bind(@NonNull ViewHolder holder, @NonNull String s, int position) {
                ...
                ImageView ivKing = holder.getViewOrNull(R.id.iv_king);
                if (ivKing != null) {
                    if (isVip) {
                        ivKing.setVisibility(GONE);
                    }else {
                        ivKing.setVisibility(VISIBLE);
                    }
                }
...
//                }
    ...
    public BottomListPopupView setVip(boolean isVip) {
        this.isVip = isVip;
        return this;
    }
